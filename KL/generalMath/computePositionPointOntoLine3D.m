function pos = computePositionPointOntoLine3D(point, line)
%LINEPOSITION3D Return the position of a 3D point projected on a 3D line
%
%   T = computePositionPointOntoLine3D(POINT, LINE)
...
%
%   T = computePositionPointOntoLine3D(POINT, LINES)
%   If LINES is an array of NL lines, return NL positions, corresponding to
%   each line.
%
%   T = computePositionPointOntoLine3D(POINTS, LINE)
